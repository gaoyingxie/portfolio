...
> 游戏开发作品集 - 包含 H5 游戏、Android 游戏和 Android 应用

## 🌐 在线访问

**作品集主页：** https://gaoyingxie.github.io/portfolio/
...
- **链接**：https://gaoyingxie.github.io/hospital-escape/

### 👶 云养娃 v4.9
- **类型**：养成模拟 · 策略 · 多结局
- **特色**：从出生到高考，48回合养成，15种结局
- **链接**：https://gaoyingxie.github.io/cloud-baby/

### 🍉 合成大西瓜
- **类型**：物理合成 · 休闲
- **特色**：体感控制，物理引擎，连击系统
- **链接**：https://gaoyingxie.github.io/watermelon-game/

### 🎯 消消乐
- **类型**：消除 · 休闲
- **特色**：经典三消玩法，限时挑战
- **链接**：https://gaoyingxie.github.io/xiaoxiaole/
...
- **技术**：React Native
- **描述**：经典切水果游戏
- **下载**：[GitHub Releases](https://github.com/gaoyingxie/fruit-ninja-rn/releases)
...
- **技术**：React Native
- **描述**：移动端计时器应用
- **下载**：[GitHub Releases](https://github.com/gaoyingxie/counter-app/releases)
...
- [xiaoxiaole](https://github.com/gaoyingxie/xiaoxiaole)
